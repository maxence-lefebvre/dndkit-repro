...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/QMl3UQtLzj)
...
```sh
npx nx serve dndkit-repro
```

To create a production bundle:

```sh
npx nx build dndkit-repro
```

To see all available targets to run for a project, run:

```sh
npx nx show project dndkit-repro
```
